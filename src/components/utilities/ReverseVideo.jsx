...
export default function ReverseVideo() {
  ...
  const handleRun = useCallback(async () => {
    ...
    try {
      outputPath = await save({
        ...
        defaultPath: inputPath.replace(/\.[^.]+$/, '') + '_reversed.mp4'
      });
    } catch (err) {
    ...
    setError(null);
    try {
      await invoke('ffmpeg_reverse_video', { inputPath, outputPath });
  ...
  return (
    <div id="page-utility-reverse-video" className="page utility-page active">
      ...
      <div className="utility-content">
        <div className="tool-card">
          <p className="tool-description">
            Воспроизведение видео и звука в обратном порядке.
          </p>
          <div className="tool-content">
            ...
            {inputPath && (
              ...
              >
                {isProcessing ? 'Обработка...' : 'Создать реверс'}
              </button>
            )}
            {error && (
